...
/*   Updated: 2025/05/03 11:48:31 by scarlos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
				...
				t_shell *shell)
{
	...
	var_len = 0;
	while (ft_isalnum(src[indices->i + 1 + var_len]) || \
				src[indices->i + 1 + var_len] == '_')
		var_len++;
...
<<<<<<< HEAD
	...
	while (src[indices.i])
	{
		...
		else if (src[indices.i] == '$' && (ft_isalpha(src[indices.i + 1]) || \
					src[indices.i + 1] == '_'))
