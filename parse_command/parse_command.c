...
static int handle_operator(t_parse *state, int *last_was_operator, t_shell *shell)
{
    char op;
    int is_double;
...
static void parse_loop(t_parse *state, t_shell *shell, t_parse_result *result, int *last_was_operator)
{
